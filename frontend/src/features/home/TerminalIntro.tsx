...
export default function TerminalIntro() {
  return (
    <div
      className="w-full min-h-[42vh] flex items-center justify-center bg-[#05070a] font-mono"
    ...
    >
      <div className="flex flex-col items-center gap-20">
        ...
        <Link
          to="/contact"
          className="inline-flex items-center gap-2 rounded-lg border border-[#1c2620] bg-[#0b0f0d] px-6 py-3 text-sm font-bold text-[#39ff9c] transition-colors hover:border-[#39ff9c] hover:bg-[#39ff9c]/10"
        >
          Get in touch
