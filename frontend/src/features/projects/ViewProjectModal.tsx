...
export default function ViewProjectModal(props: ViewProjectModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4 py-8 font-mono">
      <div className="relative flex w-full max-w-[1400px] max-h-[92vh] flex-col overflow-y-auto rounded-2xl border border-line bg-bg">
        <div className="flex justify-end px-4 pt-4 sm:px-6 sm:pt-5">
          <button
            type="button"
            onClick={onClose}
            aria-label="Close"
            className="flex h-10 w-10 items-center justify-center rounded-full text-muted transition-colors hover:bg-surface hover:text-text"
          >
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="order-2 flex flex-col p-6 pt-0 sm:order-1 sm:w-[45%] sm:p-8 sm:pt-0">
